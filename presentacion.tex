...
\alt<2>
{
$1\xrightarrow{60/100} 2$, como $Q_{21}\pi_1> Q_{12}\pi_2$, 
\begin{align*}
    \text{lanzamos moneda }\underbrace{10/11}_{2},\quad \underbrace{1/11}_{1}
\end{align*}
}
{
$2\xrightarrow{99/100} 1$ es aceptado porque $Q_{12}\pi_2\leq Q_{21}\pi_1$
}
\end{frame}
...
Comenzamos por expresar la probabilidad de que una caminata
regrese al origen en términos de probabilidades más pequeñas. 
\pause
Después introducimos funciones generadoras, de manera combinatoria.
\pause
Damos una interpretación analítica y analizamos cierto límite.
